...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>Contact - L'infini Naturel</title>
            ...
            <div class="column large-12">
                ...
                <article class="s-content__entry">
                    ...
                    <div class="s-content__media">
                        <img src="images/thumbs/contact/andrew-neel-ute2XAFQU2I-unsplash.jpg" 
                                srcset="images/thumbs/contact/andrew-neel-ute2XAFQU2I-unsplash.jpg" sizes="(max-width: 2100px) 100vw, 2100px" alt="">
                        ...
                        <div class="s-content__page-content">
                            ...
                            <div class="row block-large-1-2 block-tab-full s-content__blocks">
                                ...
                                <div class="column">
                                    <h4>Contact Info</h4>
                                    <p>
                                    sales@linfininaturel.com<br>
                                    Phone: 1(888) 708 1036
                                    </p> 
                                </div>
