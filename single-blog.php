...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>L'infini Blog | <?php echo $blogMetaTitle; ?></title>
                        ...
                        <div class="s-content__entry-meta">
                            ...
                            <div class="entry-author meta-blk">
                                <div class="author-avatar">
                                    <img class="avatar" src="images/avatars/alexandru-zdrobau-BGz8vO3pK8k-unsplash.jpg" alt="">
                                </div>
                                <div class="byline">
                                    <span class="bytext">Posted By</span>
                                    <a href="#">Elizabete De Freitas</a>
                                </div>
                            </div>
                        ...
                        while ($rowCommentChildren = mysqli_fetch_assoc($queryCheckCommentChildren)) {
                            ...
                            $commentDateChild = $rowCommentChildren['d_date_created'];
                                    ...
                                    <li class='depth-2 comment'>
                                            ...
                                            <div class='comment__meta'>
                                            <div class='comment__time'>".date("M j, Y", strtotime
                                            ($commentDateChild))."</div>
                                            </div>
                                            </div>
                                        <div class='comment__text'>
                                            <p>".$commentChild."</p>
    ...
    <form name="replyForm" id="replyForm">
        <fieldset>
            ...
            <div class="form-field">
                <input name="replayCName" id="replyCName" class="h-full-width h-remove-bottom" placeholder="Your Name" value="" type="text">
            </div>
            <div class="form-field">
    ...
    <script>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == "success") {
                            ...
                            $("#comment-error").css("display", "block");
                            $("#comment-error").html("There were an error while adding your comment. Please try again.");
                        }    
                    }    
                });
            }   
        ...
        $(document).on('submit', '#replyForm', function(e) {
            ...
            if (!name || !email || !reply) {
                ...
                $("#reply-error").css("display", "block");
                $("#reply-error").html("There were an unexpected error. Try refreshing the page.");
            } else {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data == "success") {
                        ...
                        $("#reply-error").css("display", "block");
                        $("#reply-error").html("There were an error while adding your reply. Please try again.");
                    }    
                }    
            });
        }   
