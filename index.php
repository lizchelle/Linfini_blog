    ...
    <section id="hero" class="s-hero">
        ...
        <div class="s-hero__social hide-on-mobile-small">
            ...
            <ul class="s-hero__social-icons">
                <li><a href="https://www.facebook.com/linfininaturel"><i class="fab fa-facebook-f" aria-hidden="true"></i></a></li>
                <li><a href="https://instagram.com/linfininaturel/"><i class="fab fa-instagram" aria-hidden="true"></i></a></li>
                <li><a href="https://www.linfininaturel.com"><i class="fab fa-dribbble" aria-hidden="true"></i></a></li>
            </ul>
